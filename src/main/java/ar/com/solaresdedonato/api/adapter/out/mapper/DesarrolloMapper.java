...
public class DesarrolloMapper {
    ...
    public Desarrollo toDomain(DesarrolloEntity e) {
        return Desarrollo.builder()
                ...
                .showroomVirtualUrl(e.getShowroomVirtualUrl())
                .brochurePlanosUrl(e.getBrochurePlanosUrl())
                .avanceObraUrl(e.getAvanceObraUrl())
                .solicitarInformacionUrl(e.getSolicitarInformacionUrl())
                .enable(e.isEnable())
